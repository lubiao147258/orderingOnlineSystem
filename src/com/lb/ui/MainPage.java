...
public class MainPage extends JFrame {
	...
	public MainPage() {
		...
		//个人资料panel
		/*
		JPanel panel_gerenziliao = new JPanel();
		...
		JLabel label_shoujihaoma2 = new JLabel("未绑定");
		...
		JLabel label_wodeyouxiang2 = new JLabel("未绑定");
		...
		JLabel label_shoujihaoma3 = new JLabel("[立即绑定]");
		label_shoujihaoma3.setForeground(new Color(255, 0, 0));
		...
		JLabel label_wodeyouxiang3 = new JLabel("[立即绑定]");
		label_wodeyouxiang3.setForeground(new Color(255, 0, 0));
		...
		*/
		...
		JPanel panel_dizhiguanli = new JPanel();
		panel_dizhiguanli.setBounds(186, 10, 557, 435);
		panel_center.add(panel_dizhiguanli);
		panel_dizhiguanli.setLayout(null);
		
		JLabel lblNewLabel = new JLabel("地址管理");
		lblNewLabel.setFont(new Font("微软雅黑", Font.PLAIN, 18));
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setBounds(10, 10, 102, 22);
		panel_dizhiguanli.add(lblNewLabel);
