...
public class StartOrderPage extends JFrame {
	...
	private int pageSum = (int) Math.ceil((SellerService.getFoodInfoService().size() / 14.0));
	...
	public StartOrderPage() {
		...
		panel_bottomline.setBounds(-2, 698, 779, 2);
